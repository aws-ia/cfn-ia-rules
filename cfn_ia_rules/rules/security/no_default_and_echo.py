...
from ...common import ParameterNoEchoDefault, inherit_doc_string
...
@inherit_doc_string
class ManagedBlockchainMemberNoEcho(
    ParameterNoEchoDefault, CloudFormationLintRule
):  # pylint: disable=C0115
